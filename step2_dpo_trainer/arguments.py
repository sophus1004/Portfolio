...
class ModelArguments:
    ...
    add_bos_token: Optional[str] = field(
        default=None,
        metadata={"help": "Custom beginning-of-sequence token. If provided, sets tokenizer.bos_token to this value."}
    )
...
class TrainingArguments:
    ...
    loss_type : Optional[str] = field(
        default="sigmoid",
        metadata={"help": "Type of loss function to use. Options are 'sigmoid', 'hinge', etc."}
    )
